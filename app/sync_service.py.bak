    ...
    def run_full_sync_cycle(self, since_date: str = "2024-09-01") -> Dict[str, Any]:
        ...
        try:
            for platform_id, config in PLATFORMS.items():
                ...
                self._log_sync_end(log_id, added, updated, status="SUCCESS")
                platform_reports[platform_id] = {"status": "SUCCESS", "added": added, "updated": updated}
    ...
    def _update_source_stats(self):
        ...
        with db_session() as conn:
            ...
            for row in cursor.fetchall():
                ...
                WHERE id = ?;
                """, (row["cnt"], row["min_d"], row["max_d"], now_str, row["platform_id"]))

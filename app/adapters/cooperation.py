...
new.cooperation.uz (O'zbekiston Respublikasi Yangi Elektron kooperatsiya portali - O'zRTXB) adapteri.
"""
...
class CooperationAdapter(BasePlatformAdapter):
    """
    O'zbekiston Respublikasi Yangi Elektron kooperatsiya portali (https://new.cooperation.uz) adapteri.
    """
        ...
        try:
            ...
            with urllib.request.urlopen(req, context=ctx, timeout=10) as resp:
                ...
                return {
                    ...
                    "message": f"new.cooperation.uz bilan aloqa muvaffaqiyatli ({latency} ms)"
                }
            ...
            return {
                ...
                "operator": "O'zRTXB AJ",
                "message": f"new.cooperation.uz ulanish xatosi: {str(e)}"
            }
    ...
    def get_lot_details(self, lot_id: str) -> Dict[str, Any]:
        return {
            "lot_id": lot_id,
            "url": f"{self.base_url}/trade/order/{lot_id}",
            "platform": self.platform_id
        }
    ...
    def normalize(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        lot_id = str(raw.get("id") or raw.get("order_id") or "")
        return {
            "id": f"coop_{lot_id}",
            "lot_number": str(raw.get("order_number") or lot_id),
            "title": raw.get("title", ""),
            "description": raw.get("description", ""),
            "platform_id": self.platform_id,
            "source_url": raw.get("source_url") or f"{self.base_url}/trade/order/{lot_id}",
            "procurement_type": raw.get("procurement_type", "Elektron kooperatsiya"),
